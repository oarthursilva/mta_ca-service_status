...
const data = {
    status: {
        ...
        success: "No problems",
        warning:
            "Update delayed, maintenance, details can be found in comment",
        error:
            "Data not up to date, technical problems, details can be found in comment",
    },
    remarks: {
        title: "Remarks",
        ...
        text3:
            '<p>The actual time of "last data update" can be found in each BIS report</p>',
        text4:
            "The traffic lights are only maintained by BI Team <strong>one hour</strong> before latest update for <strong>first and second load</strong>",
    },
};

function controller(parentController: any) {
    function closeDialog() {
        messagesDialog.close();
    }

    return {
        onDialogBeforeOpen(oEvent: any) {
